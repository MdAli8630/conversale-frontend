            ...
            <div className={`chat_outer ${addClass ? "chat_outer_new" : ""}`}>
                ...
                <div className="header_outer" >
                    <div className="toggle_side">
                        ...
                        <span className="title_name">Conversale</span>
                    ...
                    <div className={`chat_box ${toggle ? 'menu-toggle' : ''}`}>
                        <div className='main_chatbox'>
                                ...
                                <div className="msg_outer" id="msg_outer" style={{ height: `${windowHeight}px`, overflowY: messages.length > 0 ? 'scroll' : 'none', maxHeight: `${originalheight}px` }} >
                                    {!messages.length > 0 && !cleared > 0 ? <div className="msg_lsitings">
                                        ...
                                        <div className="inside_chat">
                                            ...
                                            <p> I’m Conversale, your creative and helpful collaborator. I have limitations and won’t always get it right, but your feedback will help me improve. </p>
                                    ...
                                    <div className='random-message'>
                                        {cleared && (
                                            <div>
                                                ...
                                                <p>"Conversale is still in its experimental phase. Chatting with it and rating its response will help improve the experience."</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="copy_right">
                                <p>Conversale may display inaccurate or offensive information that doesn’t represent our views.</p>
                            </div>
